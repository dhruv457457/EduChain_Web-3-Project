...
const TransactionList = ({ transactions, userAddress, refund, loading }) => {
  return (
    <div className="px-4 sm:px-10 lg:pr-40">
      <div className="flex flex-col border-b-4 border-customPurple rounded-md bg-customDark py-5 px-6 sm:px-10 mt-10 sm:mt-14 shadow-custom-purple md:min-h-96 md:min-w-96">
