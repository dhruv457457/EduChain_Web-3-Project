    ...
    >
      ...
      <div className="container mx-auto px-4 py-10 pt-32">
        ...
        <div className="bg-customDark p-6 rounded-lg mb-8">
          <h2 className="text-2xl font-bold mb-4">Welcome to SWC Contract System</h2>
          <p className="mb-4">
            This platform allows you to create and manage milestone-based contracts securely on the blockchain.
            You can create new contracts, fetch existing contract details, and manage milestones with ease.
          </p>
          <ul className="list-disc list-inside mb-4">
            <li>Create new contracts with specific details and milestones.</li>
            <li>Fetch and view details of existing contracts.</li>
            <li>Manage milestones by adding, approving, and completing them.</li>
          </ul>
        ...
        {showCreateForm && (
          <div id="create-contract-section" className="bg-customDark p-6 rounded-lg mb-8">
        ...
        {showFetchForm && (
          <div id="fetch-contract-section" className="bg-customDark p-6 rounded-lg mb-8">
